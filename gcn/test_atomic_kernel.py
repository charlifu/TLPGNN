...
def main(args):
    cuda_source = "const int blocks = " 
    cuda_source += str(args.blocks)
    cuda_source += ";\n" + open("atomic_kernel.cu").read()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--blocks", type=int, default=640,
